...
const submitMadLibs = (event) => {
   ...
   const story = <p> Hi! My name is <span class="inserted-text">${userSubmission.name_1}</span> and I have a secret to share with you. I'm a normal
   ...
   I save the world every night. But when I wake up in the morning, I
   go back to my normal life at <span class="inserted-text">${userSubmission.school}</span> school. </p>
